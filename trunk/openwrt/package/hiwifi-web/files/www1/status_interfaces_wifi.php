...
<p class="pgtitle">状态: 无线接口</p>
		...
		<input type="hidden" name="interface" value="wan">
                ...
                <td colspan="2" class="listtopic">
                  无线接口
				  (radio0) &nbsp;&nbsp; <a href="status_graph.php?ifname=radio0">实时监测</a>
				</td>
              </tr>
              <tr>
                ...
                <td colspan="2" class="listtopic">
                  无线接口
				  (radio1) &nbsp;&nbsp; <a href="status_graph.php?ifname=radio1">实时监测</a>
				</td>
              </tr>
              <tr>
                <td width="22%" class="vncellt">Status</td>
                ...
                <td colspan="2" class="listtopic">
                  无线接口
				  (radio2) &nbsp;&nbsp; <a href="status_graph.php?ifname=radio2">实时监测</a>
				</td>
              </tr>
              <tr>
                <td width="22%" class="vncellt">Status</td>
